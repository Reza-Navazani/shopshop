            ...
            <div className="w-full space-y-4">
                ...
                {product && (
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        {product.unhealthy_ingredients && product.unhealthy_ingredients !== 'None detected' && (
                            <div className="mt-4 bg-yellow-50 p-3 rounded-md">
                                <h4 className="text-md font-medium text-yellow-800">Potentially Unhealthy Ingredients:</h4>
                                <p className="text-yellow-700 mt-1">{product.unhealthy_ingredients}</p>
                            </div>
                        )}
